...
Everything runs locally, zero API calls. We covered the same interpretability techniques that Anthropic and OpenAI researchers use for mechanistic interpretability and AI safety work—token probability distributions, attention weight extraction, circuit analysis, and agent reasoning traces.
Check out the live demo: https://albert-opher-anthropic-ai-interpretability.streamlit.app
